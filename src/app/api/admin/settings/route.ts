...
export async function POST(request: Request) {
  try {
    ...
    const { emailSendingEnabled, showCreatorAttribution, homePageMessage, onboardingMandatory } = body || {};

    if (typeof emailSendingEnabled !== 'boolean' && typeof showCreatorAttribution !== 'boolean' && typeof homePageMessage !== 'string' && typeof onboardingMandatory !== 'boolean') {
