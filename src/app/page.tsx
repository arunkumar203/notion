  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <section className="relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 lg:pt-24 lg:pb-28 relative">
          {/* Creator note positioned absolutely so it doesn't affect layout */}
          <div className="absolute right-0 sm:right-2 top-2 z-20 text-[11px] sm:text-xs text-gray-700">
            App created by R. Arun Kumar
          </div>
