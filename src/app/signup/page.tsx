...
export default function SignUpPage() {
  ...
  useEffect(() => {
    // Only redirect if verified. If unverified (signup flow), let the user stay or be handled by handleSubmit's redirect
      ...
      if (code || message) {
        switch (code || message) {
          case 'auth/email-already-in-use':
            setError('User already exists for this email address. Please try logging in.');
            break;
