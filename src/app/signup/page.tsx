        ...
        <div className="max-w-md w-full space-y-8 bg-white p-6 rounded-lg shadow-md">
          ...
          <form className="mt-6 space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-4">
              <button
                type="submit"
                disabled={loading || isGoogleLoading || password.length < 6 || password !== confirmPassword}
                className={`w-full flex justify-center py-2.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 ${loading || isGoogleLoading || password.length < 6 || password !== confirmPassword ? 'opacity-70 cursor-not-allowed bg-blue-400' : ''}`}
              >
                {loading ? (
                  <>
