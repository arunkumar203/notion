      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-8">
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          <div className="space-y-8">
            {/* v1.9 */}
            <div>
              <div className="inline-flex items-center rounded-md bg-emerald-50 px-2.5 py-1 text-xs font-medium text-emerald-700 ring-1 ring-inset ring-emerald-200">v1.9</div>
              <ul className="mt-3 list-disc list-inside text-sm text-gray-800 space-y-1">
                <li><strong>Workspaces:</strong> Introduced workspaces to better organize your notebooks! Create multiple workspaces to separate personal, work, or project notes.</li>
                <li><strong>Migration:</strong> All your existing notebooks have been automatically migrated to a new workspace named <strong>"Personal Workspace"</strong>.</li>
                <li><strong>Workspace Sharing:</strong> Invite others to collaborate with role-based permissions (Owner, Admin, Editor, Commenter, Viewer).</li>
                {/* <li><strong>Role-Based Access Control:</strong> Granular permissions for each role including file management, page editing, commenting, and admin operations.</li> */}
                <li><strong>Audit Logs:</strong> Comprehensive activity tracking for workspace actions including page edits, file uploads/deletions, comment operations, and invite management.</li>
                <li><strong>Commenting System:</strong> Add comments to selected text with markdown support, edit/delete own comments, and expanded view for long comments.</li>
                {/* <li><strong>View Patterns:</strong> OneNote-style page backgrounds with rule lines (Narrow, College, Standard, Wide) and grids (Small, Medium, Large, Very Large) - saved per page.</li> */}
                {/* <li><strong>Settings Menu:</strong> New Settings button in the ribbon with View submenu for quick access to page background patterns.</li> */}
                {/* <li><strong>File Deletion:</strong> Editors can now delete their own uploaded files; admins/owners can delete any file in the workspace.</li> */}
                <li><strong>Improved Storage Tracking:</strong> Better tracking of file uploads with workspace association for accurate storage usage reporting.</li>
              </ul>
            </div>
            {/* v1.8 */}
            <div>
              <div className="inline-flex items-center rounded-md bg-indigo-50 px-2.5 py-1 text-xs font-medium text-indigo-700 ring-1 ring-inset ring-indigo-200">v1.8</div>
              <ul className="mt-3 list-disc list-inside text-sm text-gray-800 space-y-1">
                <li><strong>Two-Factor Authentication (2FA):</strong> Secure your account with TOTP (Time-based One-Time Password) apps like Google Authenticator or Authy, plus downloadable backup codes for recovery.</li>
              </ul>
            </div>
            {/* v1.7 */}
            <div>
              <div className="inline-flex items-center rounded-md bg-indigo-50 px-2.5 py-1 text-xs font-medium text-indigo-700 ring-1 ring-inset ring-indigo-200">v1.7</div>
              <ul className="mt-3 list-disc list-inside text-sm text-gray-800 space-y-1">
                <li><strong>System Maintenance Mode:</strong> Admin-controlled system-wide maintenance mode with custom messaging, admin bypass, and public path access for login/signup.</li>
