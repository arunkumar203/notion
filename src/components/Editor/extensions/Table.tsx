...
type ColumnType = 'text' | 'select' | 'number' | 'percentage' | 'date' | 'checkbox';
...
}> = ({ col, index, editable, onName, onType, onManageTags, onDelete, onInsertBefore, onInsertAfter, onMoveLeft, onMoveRight, totalColumns, isHovered, onResizeStart }) => {
